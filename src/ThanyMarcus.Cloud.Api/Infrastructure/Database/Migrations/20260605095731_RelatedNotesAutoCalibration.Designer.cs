...
namespace ThanyMarcus.Cloud.Api.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260605095731_RelatedNotesAutoCalibration")]
    partial class RelatedNotesAutoCalibration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThanyMarcus.Cloud.Api.Features.Entities.Entity", b =>
                {
                    ...
                    b.Property<Guid?>("StubNoteId")
                        .HasColumnType("uuid")
                        .HasColumnName("stub_note_id");
            ...
            modelBuilder.Entity("ThanyMarcus.Cloud.Api.Features.EntitySuggestions.EntitySuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("AcceptedEntityId")
                        .HasColumnType("uuid")
                        .HasColumnName("accepted_entity_id");
                    ...
                    b.Property<Instant?>("DismissedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("dismissed_at");

                    b.Property<int>("DistinctNoteCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("distinct_note_count");
                    ...
                    b.Property<JsonDocument>("Occurrences")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("ThanyMarcus.Cloud.Api.Features.Ingest.Attachment", b =>
                {
                    ...
                    b.ToTable("attachments", null, t =>
                        {
                            t.HasCheckConstraint("ck_attachments_extraction_status", "extraction_status IN ('pending','extracted','extracted_minimal','skipped','referenced','failed')");

                            t.HasCheckConstraint("ck_attachments_kind", "kind IN ('url','image','voice','file')");

                            t.HasCheckConstraint("ck_attachments_metadata_only_url", "mode <> 'metadata' OR kind = 'url'");

                            t.HasCheckConstraint("ck_attachments_mode", "mode IN ('extract','reference','metadata')");
            ...
            modelBuilder.Entity("ThanyMarcus.Cloud.Api.Features.Ingest.Note", b =>
                {
                    ...
                    b.ToTable("notes", null, t =>
                        {
                            t.HasCheckConstraint("ck_notes_kind", "kind IN ('synth_note','entity_stub')");
            ...
            modelBuilder.Entity("ThanyMarcus.Cloud.Api.Features.Entities.Entity", b =>
                {
                    b.HasOne("ThanyMarcus.Cloud.Api.Features.Ingest.Note", null)
                        .WithMany()
                        .HasForeignKey("StubNoteId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_entities_notes_stub_note_id");
                });
