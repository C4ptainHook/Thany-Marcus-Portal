...
namespace ThanyMarcus.Cloud.Api.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260518221133_CompositeNoteSchemaV2")]
    partial class CompositeNoteSchemaV2
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("ingest_jobs", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_ingest_jobs_status", "status IN ('processing','queued','extracting_attachments','composing','routing','extracting_entities','embedding','succeeded','failed_extraction','failed_composition','failed_route','failed_entities','failed_embedding','dead_lettered')");
                        });
                });
